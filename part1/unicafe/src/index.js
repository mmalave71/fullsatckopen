...
const Statistics =({good,neutral,bad})=>{
  ...
  return (
          ...
          <table border="1px">
          <tbody>
          <tr><Statistic texto="Good" valor={good}/></tr>
          <tr><Statistic texto="Neutral" valor={neutral}/></tr>
          <tr><Statistic texto="Bad" valor={bad}/></tr>
          <tr><Statistic texto="All" valor={good+neutral+bad}/></tr>
          <tr><Statistic texto="Average" valor={promedio(good,neutral,bad)}/></tr>
          <tr><Statistic texto="Positive" valor={positivos(good,neutral,bad)} /></tr>
          </tbody>
          </table>
          </>
  );
